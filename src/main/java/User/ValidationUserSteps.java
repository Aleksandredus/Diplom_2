...
public class ValidationUserSteps {
    ...
    public void createUserResponsePositive(ValidatableResponse response, int code, Boolean status) {
    ...
    public void createUserResponseNegative(ValidatableResponse response) {
